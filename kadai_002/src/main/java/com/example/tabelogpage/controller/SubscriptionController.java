...
import com.example.tabelogpage.service.StripeService;
...
public class SubscriptionController {
   ...
   public String create(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, @RequestParam String paymentMethodId, RedirectAttributes redirectAttributes) {
       ...
       // ユーザーのロールを更新する
       userService.updateRole(user, "ROLE_PAID"); // ROLE_PAID_MEMBER から ROLE_PAID に修正
       userService.refreshAuthenticationByRole("ROLE_PAID"); // ROLE_PAID_MEMBER から ROLE_PAID に修正
   ...
   public String delete(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, RedirectAttributes redirectAttributes) {
       ...
       // ユーザーのロールを更新する
       userService.updateRole(user, "ROLE_FREE"); // ROLE_FREE_MEMBER から ROLE_FREE に修正
       userService.refreshAuthenticationByRole("ROLE_FREE"); // ROLE_FREE_MEMBER から ROLE_FREE に修正
