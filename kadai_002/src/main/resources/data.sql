...
-- ID 2 トラットリア・リッコ（store_id=2）にレビュー
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (2, 1, 2, 4, 'パスタが絶品！ワインも豊富でまた来たいです。');
...
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (4, 5, 4, 5, '静かで居心地が良い最高のカフェです。読書が進みました。'); -- Book Cafe moumou (ID: 4)
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
...
-- 寿司/和食 (ID: 5, 9, 13)
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (8, 6, 5, 4, 'ランチの海鮮丼が新鮮でボリューム満点。コスパが良い！'); -- 名駅前 海鮮問屋 (ID: 5)
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
...
-- カフェ
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (12, 7, 12, 5, '抹茶の苦味が絶妙で、和菓子との組み合わせが最高でした。'); -- 抹茶と甘味処 nagi (ID: 12)
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
...
-- イタリアン
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (15, 5, 18, 4, '魚介が新鮮で、地中海料理の味付けがとても良かったです。'); -- 地中海レストラン Baro (ID: 18)
...
-- イタリアン
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (20, 7, 22, 4, 'ワインの種類が豊富で、陽気な雰囲気で楽しめました。'); -- トラットリア フォルテ (ID: 22)
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
...
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (24, 6, 33, 5, '高級感があり、お寿司も会席も全てが素晴らしかったです。'); -- 寿司割烹 粋 (ID: 33)
...
-- カフェ
INSERT IGNORE INTO reviews (id, user_id, store_id, star_rating, comment)
VALUES (27, 4, 36, 5, 'レトロな内装が可愛く、写真映えするカフェでした。'); -- カフェ レトロ レトロ (ID: 36)
...
INSERT IGNORE INTO roles (id, name) VALUES (1, 'ROLE_FREE');      -- 無料会員
INSERT IGNORE INTO roles (id, name) VALUES (2, 'ROLE_PAID');      -- 有料会員 
INSERT IGNORE INTO roles (id, name) VALUES (3, 'ROLE_ADMIN');     -- 管理者
...
VALUES (1, '佐藤 太郎', 'サトウ タロウ', '460-0003', '愛知県名古屋市中区錦1-1-1', '090-1234-5678', 'taro.sato@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 'cus_TYMwWqL1lxu3rx' , 2, true);

-- ID 2: 鈴木 花子 (ROLE_FREE)
INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (2, '鈴木 花子', 'スズキ ハナコ', '450-0002', '愛知県名古屋市中村区名駅4-27-1', '090-1234-5678', 'hanako.suzuki@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 1, true);

-- ID 3: 高橋 義勝 (ROLE_PAID)
INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (3, '高橋 義勝', 'タカハシ ヨシカツ', '444-0044', '愛知県岡崎市康生通西4-71', '090-1234-5678', 'yoshikatsu.takahashi@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO',  NULL , 2,true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (4, '田中 幸美', 'タナカ サチミ', '440-0897', '愛知県豊橋市松葉町1-11', '090-1234-5678', 'sachimi.tanaka@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (5, '伊藤 雅', 'イトウ ミヤビ', '471-0025', '愛知県豊田市西町6-85-1', '090-1234-5678', 'miyabi.ito@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (6, '渡辺 正保', 'ワタナベ マサヤス', '491-0858', '愛知県一宮市栄3-1-2', '090-1234-5678', 'masayasu.watanabe@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (7, '山本 真由美', 'ヤマモト マユミ', '485-0041', '愛知県小牧市中央1-1', '090-1234-5678', 'mayumi.yamamoto@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (8, '中村 安民', 'ナカムラ ヤスタミ', '448-0858', '愛知県刈谷市大手町1-1', '090-1234-5678', 'yasutami.nakamura@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (9, '小林 章緒', 'コバヤシ アキオ', '446-0032', '愛知県安城市御幸本町1-1', '090-1234-5678', 'akio.kobayashi@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (10, '加藤 祐子', 'カトウ ユウコ', '470-2200', '愛知県知多郡阿久比町', '090-1234-5678', 'yuko.kato@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (11, '吉田 秋美', 'ヨシダ アキミ', '480-1121', '愛知県長久手市山越901', '090-1234-5678', 'akimi.yoshida@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2,true );

INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (12, '山田 信平', 'ヤマダ シンペイ', '464-0802', '愛知県名古屋市千種区星ヶ丘元町15', '090-1234-5678', 'shinpei.yamada@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 2, true);

-- 管理者 (role_id = 3)
INSERT IGNORE INTO users (id, name, furigana, postal_code, address, phone_number, email, password, stripe_customer_id, role_id, enabled) 
VALUES (13, '中村　ゆり', 'ナカムラ　ユリ', '444-1234', '愛知県岡北名古屋市田中4-71', '090-1234-9876', 'yuri.nakamura@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', NULL, 3,true);


-- #################################
-- 7. reservation テーブル (日時入り)
-- #################################
